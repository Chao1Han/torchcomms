...
onecclResult_t DefaultXcclApi::broadcast(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclBroadcast(sendbuff, recvbuff, count, datatype, root, comm, stream);
}
...
onecclResult_t DefaultXcclApi::bcast(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclBcast(buff, count, datatype, root, comm, stream);
}
...
onecclResult_t DefaultXcclApi::allReduce(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclAllReduce(sendbuff, recvbuff, count, datatype, op, comm, stream);
}
...
onecclResult_t DefaultXcclApi::allGather(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclAllGather(sendbuff, recvbuff, sendcount, datatype, comm, stream);
}
